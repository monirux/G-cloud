...
rm -rf win7 win7.qcow2 ngrok ngrok.zip ng.sh > /dev/null 2>&1
echo "Download windows files"
wget -O win7.qcow2 https://app.vagrantup.com/thuonghai2711/boxes/AndroidQCOW2/versions/1.0.2/providers/qemu.box
echo "Wait..."
